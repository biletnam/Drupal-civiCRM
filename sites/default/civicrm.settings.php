...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/drupalcivicrm?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:root@localhost/drupalcivicrm_civi?new_link=true');
  }
}
...
$civicrm_root = '/var/www/html/drupalcivicrm/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/drupalcivicrm/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://192.168.1.1/drupalcivicrm/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '091558ccfd968f6aed3e17f85e7f734c');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/drupalcivicrm/sites/default/files/civicrm/templates_c//mail.log');
// }
